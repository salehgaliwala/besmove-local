...
ThriveFocusOptions.display_fields = {
    template1: ["container-focus-template", "container-focus-color", "container-focus-image", "container-focus-image2",
        "container-heading-text", 'container-subheading-text', "container-button-text", "container-button-color", "container-button-link", "container-new-tab"],
    template2: ["container-focus-template", "container-focus-color", "container-optin", "container-heading-text",
        "container-focus-image", "container-focus-image2", "container-focus-image2", 'container-subheading-text', "container-button-text", "container-button-color",],
    template3: ["container-focus-template", "container-focus-color", "container-heading-text", 'container-subheading-text',
        "container-button-text", "container-button-color", "container-button-link", "container-new-tab", "container-focus-image"],
    template4: ["container-focus-template", "container-focus-color", "container-optin", "container-heading-text",
        'container-subheading-text', "container-button-text", "container-button-color"],
    template5: ["container-focus-template", "container-focus-color", "container-focus-image", "container-heading-text",
        'container-subheading-text', "container-button-text", "container-button-color", "container-button-link", "container-new-tab"],
    template6: ["container-focus-template", "container-focus-color", "container-optin", "container-focus-image", "container-heading-text",
        'container-subheading-text', "container-button-text", "container-button-color", "container-button-link", "container-new-tab"],
    custom: ["postdivrich", "container-focus-color", "container-focus-template", "container-subheading-text"]
};

ThriveFocusOptions.all_fields = ["postdivrich", "container-heading-text", "container-focus-color", 'container-subheading-text', "container-button-text", "container-button-color", "container-focus-image2",
...
jQuery(document).ready(function () {
    ...
    jQuery(".thrive_meta_focus_display_post_type").click(function () {
        if (jQuery(this).val() === "post") {
            ...
            jQuery("input[name='thrive_meta_focus_page_blog']").prop('checked', false);
            jQuery("input[name='thrive_meta_focus_page_archive']").prop('checked', false);
        } else {
    ...
    var file_frame2;
    jQuery('#thrieve_btn_focus_image2').click(function (event) {
        event.preventDefault();
        if (file_frame2) {
            file_frame2.open();
            return;
        ...
        file_frame2.on('select', function () {
            ...
            jQuery("#thrive_meta_focus_image2_hidden").val(attachment.url);
            jQuery("#thrive_meta_focus_image2").val(attachment.url);
        });
        file_frame2.open();
    });
    ...
    jQuery("#thrieve_btn_focus_clear_image2").click(function () {
        jQuery("#thrive_meta_focus_image2_hidden").val("");
        jQuery("#thrive_meta_focus_image2").val("");
    });
...
ThriveFocusOptions.preview_focus_area_handler = function () {
    ...
    var postData = {
        ...
        'thrive_meta_focus_heading_text': jQuery("#thrive_meta_focus_heading_text").val().replace(/"/g, '\''),
        'thrive_meta_focus_subheading_text': subheading_content.replace(/"/g, '\''),
        'thrive_meta_focus_button_text': jQuery("#thrive_meta_focus_button_text").val().replace(/"/g, '\''),
        'thrive_meta_focus_button_color': jQuery("#thrive_meta_focus_button_color").val(),
        'thrive_meta_focus_spam_text': jQuery("#thrive_meta_focus_spam_text").val().replace(/"/g, '\''),
        'thrive_meta_focus_image': jQuery("#thrive_meta_focus_image").val(),
        'thrive_meta_focus_image2': jQuery("#thrive_meta_focus_image2").val(),
        'thrive_meta_focus_button_link': jQuery("#thrive_meta_focus_button_link").val(),
        'thrive_meta_focus_new_tab': jQuery("input[name='thrive_meta_focus_new_tab']:checked").val(),
...
ThriveFocusOptions.hideUnsuportedFields = function (template_number) {
    ...
    var _location = jQuery("#thrive_meta_focus_display_location");

    _location.find('option').each(function () {
        jQuery(this).removeAttr('disabled');
    });

    if (template_number == 3 || template_number == 4 || template_number == 5 || template_number == 6) {
        _location.find('option[value="top"]').attr("disabled", "disabled").removeAttr("selected");
    }

    if (template_number == 1 || template_number == 2) {
        _location.find('option[value="bottom"], option[value="between_posts"]').attr("disabled", "disabled").removeAttr("selected");
    }

    _location.trigger('change');
};
