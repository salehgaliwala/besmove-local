...
<div class="thrive-page-settings">
	...
	<form action="<?php echo admin_url( "admin.php?page=thrive_admin_page_templates&noheader=true" ); ?>" id=""
		...
		<table class="page-template-table">
			...
			<tr>
				<td colspan="2">
					<input type="checkbox" id="chk_page_tpl_lead_generation" name="page_tpl_lead_generation_page"/>
					<label class='ptf' for="chk_page_tpl_lead_generation">Lead Generation Page</label>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="checkbox" id="chk_page_tpl_lead_generation"
					       name="page_tpl_lead_generation_video_page"/>
					<label class='ptf' for="chk_page_tpl_video_lead_generation">Lead Generation Video Page</label>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="checkbox" id="chk_page_tpl_email_confirmation"
					       name="page_tpl_email_confirmation_page"/>
					<label class='ptf' for="chk_page_tpl_email_confirmation">Email Confirmation Page</label>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="checkbox" id="chk_page_tpl_thank_you" name="page_tpl_download_page"/>
					<label class='ptf' for="chk_page_tpl_thank_you">Download Page</label>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="checkbox" id="chk_page_tpl_sales_1" name="page_tpl_sales_page"/>
					<label class='ptf' for="chk_page_tpl_sales_1">Sales Page Template</label>
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<input type="checkbox" id="chk_page_tpl_homepage2" name="page_tpl_homepage"/>
					<label class='ptf' for="chk_page_tpl_homepage2">Homepage</label>
				</td>
			</tr>
			...
			<tr <?php if ( ! defined( "TVE_VERSION" ) ): ?>style="display:none;"<?php endif; ?>>
				<td colspan="2">
					...
					<label class='ptf'
					       for="editable_with_tcb"><b><?php _e( "Make these pages editable with Thrive Architect", 'thrive' ); ?></b></label>
				</td>
			</tr>
