...
class MyTheme_Customize {
	...
	public static function header_output() {
		...
		<style type="text/css">.wp-video-shortcode {
			...
			self::generate_css( '.cnt p, .tve-woocommerce .product p, .tve-woocommerce .products p, .brd ul li, header nav ul li a, header nav ul li > ul li a, .has-extended.has-heading .colch, footer, footer .fmm p, .aut-f', 'font-family', 'thrivetheme_body_font' );
