...
function thrive_theme_options_init() {
	...
	add_settings_field( 'logo_bg_color', $options_titles['logo_bg_color'], 'thrive_settings_field_logo_bg_color', 'theme_options', 'general', $options );
	...
	//add_settings_field('site_background', $options_titles['site_background'], 'thrive_settings_field_site_background', 'theme_options', 'general', $options);
	...
	add_settings_field( 'footer_popular_posts', $options_titles['footer_popular_posts'], 'thrive_settings_field_footer_popular_posts', 'theme_options', 'general', $options );
...
function thrive_theme_options_validate( $input ) {
	...
	/*
	 * TODO - uncomment this when implementing the apprentice feature
...
function thrive_settings_field_logo_bg_color( $options ) {
	echo "<input class='thrive_options' type='text' name='thrive_theme_options[logo_bg_color]' id='thrive_theme_options_logo_bg_color' value='" . esc_attr( $options['logo_bg_color'] ) . "' /><br/>";
...
function thrive_settings_field_site_background( $options ) {
	echo "<input class='thrive_options' type='text' name='thrive_theme_options[site_background]' id='thrive_theme_options_site_background' value='" . esc_attr( $options['site_background'] ) . "' /><br/>";
	echo "<input type='button' class='thrive_options pure-button upload' id='thrive_theme_options_site_background_btn' value=' " . __( "Upload" ) . " ' />";
	echo "<input type='button' class='thrive_options pure-button clear-field remove' id='thrieve_theme_btn_delete_site_background' value=' " . __( "Remove" ) . " ' />";
}
...
function thrive_settings_field_footer_popular_posts( $options ) {
	$checked_on  = ( $options['footer_popular_posts'] == 1 ) ? "checked" : "";
	$checked_off = ( $options['footer_popular_posts'] == 0 ) ? "checked" : "";
	echo "<input class='toggle toggle-left' type='radio' id='footer_popular_posts_true' name='thrive_theme_options[footer_popular_posts]' value='1' $checked_on />
    <label for='footer_popular_posts_true' class='btn'>" . __( 'On', 'thrive' ) . "</label>";
	echo "<input class='toggle toggle-right' type='radio' id='footer_popular_posts_false' name='thrive_theme_options[footer_popular_posts]' value='0' $checked_off />
    <label for='footer_popular_posts_false' class='btn'>" . __( 'Off', 'thrive' ) . "</label>";
}
...
function thrive_settings_field_sidebar_alignement( $options ) {
	...
	$checked_right = ( $options['sidebar_alignement'] != 'left' ) ? "checked" : "";
...
function thrive_settings_field_navigation_type( $options ) {
	...
	$checked_1 = ( $options['navigation_type'] != "float" ) ? "checked" : "";
...
function thrive_settings_field_social_site_image( $options ) {
	...
	echo '<input type="button" class="thrive_options pure-button upload thrive-select-image" id="thrive_meta_social_button_upload" value="Upload"/>
