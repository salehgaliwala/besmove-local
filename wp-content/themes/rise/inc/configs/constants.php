...
define( "TT_DEFAULT_AUTHORBOX_IMAGE", "testimonials.jpg" );
...
function _thrive_get_theme_image_sizes_array( $key = null ) {
	...
	$tt_image_sizes = array(
		"tt_post_icon"             => array( 80, 80 ),
		//tabs widget, post list shortcode
		"tt_featured_thumbnail"    => array( 220, 220 ),
		"tt_extended_menu"         => array( 250, 100 ),
		"tt_related_posts"         => array( 280, 150 ),
		//related posts
		"tt_grid_layout"           => array( 510, 238 ),
		//grid si masonry si post gallery ii pt post allery. grig 370*150, masonry: 460*220
		"tt_featured_wide_sidebar" => array( 750, 415 ),
		"tt_featured_wide_narrow"  => array( 975, 487 ),
		"tt_featured_wide_full"    => array( 1190, 595 ),
	);
