...
<div id="tqb-editor-replace">
	<div id="tve_flt" class="tve_flt">
		<div class="tqb-template-style-<?php echo $variation['style'] ?>">
	...
	<div style="opacity: .6; padding-top: 240px; text-align: center; position: relative; z-index: -1;">
		<h4><?php echo __( 'This is a Variation type called "Result page". It is displayed on posts that have its code in the content.', Thrive_Quiz_Builder::T ) ?></h4>
	</div>
</div>
