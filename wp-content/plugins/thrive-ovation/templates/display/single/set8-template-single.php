<div id="<?php echo $unique_id; ?>" class="tvo-testimonials-display tvo-testimonials-display-single tvo-set8-template tve_black">
			...
			<div class="tvo-testimonial-display-item tvo-apply-background">
				<div class="tvo-item-grid">
					...
					<div class="tvo-quote-wrapper">
						<div
								class="tvo-testimonial-quote <?php echo ( empty( $testimonial['title'] ) ) ? 'tvo-testimonial-quote-small' : '' ?>">
