 ...
 * @return mixed
 */
function tvo_tcb_add_elements( $elements ) {

	require_once dirname( __FILE__ ) . '/classes/class-tcb-capture-testimonials-element.php';
	require_once dirname( __FILE__ ) . '/classes/class-tcb-display-testimonials-element.php';

	$elements['ovation_capture'] = new TCB_Capture_Testimonials( 'ovation_capture' );
	$elements['ovation_display'] = new TCB_Display_Testimonials( 'ovation_display' );
