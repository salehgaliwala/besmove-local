...
return array(
	'blank_v2'                                  => array(
		...
		'set'          => 'blank',
		'style_family' => 'Flat',
		'head_css'     => '@media (min-width: 300px){[data-css="tve-u-15e09c94f7d"] { background-color: #fff; }.tve_post_lp > div > #tve_editor { margin-left: auto; margin-right: auto; max-width: 1080px; padding: 0px 20px; }}@media (max-width: 767px){.tve_post_lp > div > #tve_editor { padding: 0px 10px; }}',
